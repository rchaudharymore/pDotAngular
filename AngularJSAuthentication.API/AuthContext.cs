...
//        //IEnumerable<Leave> AllLeavesbyCompanyId(int cmpid);
//        Leave AddLeave(Leave leave);
//        //TaskType PutLeave(Leave customer); 
...
//        IEnumerable<Expense> AllExpenses(int compid);
...
//        IEnumerable<Category> AllCategorys(int compid);
...
//            People ppl = Peoples.Where(x => x.PeopleID == projecttask.PeopleID).Select(x => x).FirstOrDefault();
...
//            if (peoples.Count == 0)
//            {
//                people.FullName = people.PeopleFirstName + " " + people.PeopleLastName;
...
//                proj.FullName = objCust.PeopleFirstName + " " + objCust.PeopleLastName;
...
//        public IEnumerable<Category> AllCategorys(int compid)
//        {
            
//                if (Categorys.AsEnumerable().Count() > 0)
//                {
//                    return Categorys.Where(p => p.CompanyId == compid).AsEnumerable();
//                }
//                else
...
//        {
//            List<Category> categorys = Categorys.Where(c => c.CategoryName.Trim().Equals(category.CategoryName.Trim())).ToList();
...
//        public Category PutCategory(Category objCust)
//        {
//            Category proj = Categorys.Where(x => x.CategoryID == objCust.CategoryID).FirstOrDefault();
//            if (proj != null)
//            {
//                proj.UpdatedDate = DateTime.Now;
//                //proj.Client = objCust.Client;
//                proj.CategoryName = objCust.CategoryName;
//                proj.Discription = objCust.Discription;                
...
////public IQueryable<object> AllExpenses(int compid)
////{
////    Expense list = new Expense();
////    var query = from x in Expenses
////                join y in Projects
////                on x.ProjectID equals y.ProjectID
////                join z in Categorys
////                on x.CategoryID equals z.CategoryID
////                select new { x.Amount, x.CategoryID, x.ProjectID, x.Date, x.Discription, x.FileUrl, x.CreatedBy, x.CreatedDate, x.ExpenseID, x.IsBillable, y.ProjectName, z.CategoryName };
////    return query;
////}
//        public IEnumerable<Expense> AllExpenses(int compid)
//        {

//            if (Expenses.AsEnumerable().Count() > 0)
//            {
//                return Expenses.Where(e => e.CompanyId == compid).AsEnumerable();
//            }
//            else

//            {
//                List<Expense> expense = new List<Expense>();
//                return expense.AsEnumerable();
//            }
...
//{
//    List<Expense> expenses = Expenses.Where(c => c.ExpenseID.Equals(expense.ExpenseID)).ToList();
//            Project prj = Projects.Where(x => x.ProjectID == expense.ProjectID).Select(x => x).FirstOrDefault();
//            Category cat = Categorys.Where(x => x.CategoryID == expense.CategoryID).Select(x => x).FirstOrDefault();
...
//        expense.ProjectName = prj.ProjectName;
//        expense.CategoryName = cat.CategoryName;
...
//public Expense PutExpense(Expense objCust)
//{
//    Expense proj = Expenses.Where(x => x.ExpenseID == objCust.ExpenseID).FirstOrDefault();
//            Project prj = Projects.Where(x => x.ProjectID == objCust.ProjectID).Select(x => x).FirstOrDefault();
//            Category cat = Categorys.Where(x => x.CategoryID == objCust.CategoryID).Select(x => x).FirstOrDefault();
//            if (proj != null)
//    {
//        proj.UpdatedDate = DateTime.Now;
//        //proj.Client = objCust.Client;    
//        proj.ProjectID = objCust.ProjectID;
//        proj.CategoryID = objCust.CategoryID;
//        proj.Discription = objCust.Discription;
//        proj.Date = objCust.Date;
//        proj.Amount = objCust.Amount;
//        proj.FileUrl = objCust.FileUrl;
//        proj.IsBillable = objCust.IsBillable;

//        proj.ProjectName = prj.ProjectName;
//        proj.CategoryName = cat.CategoryName;

//        proj.CreatedBy = objCust.CreatedBy;
//        proj.CreatedDate = objCust.CreatedDate;
//        proj.UpdateBy = objCust.UpdateBy;

//        Expenses.Attach(proj);
//        this.Entry(proj).State = EntityState.Modified;
//        this.SaveChanges();
//        return objCust;
//    }
...
//        {
//            List<Leave> leaves = Leaves.Where(c => c.EmployeeName.Trim().Equals(leave.EmployeeName.Trim())).ToList();
