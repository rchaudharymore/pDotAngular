...
//    JAN CHANGED LINE 238
//	NIC CHANGED LINE 113
...
//			$(data.holder).css('margin-top', settings.marginTop);
...
//					if (event.which==event.data.delimiter.charCodeAt(0) || event.which==13 || event.which==";".charCodeAt(0) ) { //Added ; as delimiter option
...
//		// Trigger a change event on the hidden tags input list in case anyone is listening
//		$(obj).trigger('change');
//	};
